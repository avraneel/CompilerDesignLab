...
static const flex_int16_t yy_base[19] =
    {   0,
        0,    0,   21,   22,    0,    4,    0,    0,   18,   16,
       14,    8,    0,    9,    0,   22,   12,   14
    } ;

static const flex_int16_t yy_def[19] =
    {   0,
       16,    1,   16,   16,   17,   16,   17,    6,    6,   18,
        6,   16,    9,   18,   12,    0,   16,   16
    } ;

static const flex_int16_t yy_nxt[28] =
    {   0,
        4,    5,    6,    5,    4,    8,    9,    7,   10,   14,
       12,   15,   10,    7,    7,   10,   13,   10,   12,   11,
       16,    3,   16,   16,   16,   16,   16
    } ;

static const flex_int16_t yy_chk[28] =
    {   0,
        1,    1,    1,    1,    1,    6,    6,    6,    6,   12,
       12,   14,   12,   17,   17,   18,   11,   18,   10,    9,
        3,   16,   16,   16,   16,   16,   16
    } ;
